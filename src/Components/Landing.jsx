    ...
    <div className=' border-b border-neutral-900 pb-4 lg:mb-35 mt-40' id='home'>
        ...
        <div className='flex flex-wrap'>
            <div className='w-full lg:w-1/2'>
              ...
              initial="hidden"
              animate="visible"
              className="relative p-[2px] rounded-full bg-gradient-to-r from-purple-500 via-pink-300 to-purple-500 hover:bg-gradient-to-r hover:from-purple-500 hover:via-pink-300 hover:to-purple-500"
            >
              <div className="flex items-center justify-center bg-slate-950 rounded-full h-full w-full hover:bg-transparent hover:text-black">
                <a
                  href="/cv.pdf"
                  download="Priyanshi_Mittal_Resume.pdf"
                  className="px-6 py-2 font-semibold text-white rounded-full hover:text-black"
                >
                  Download CV
                </a>
              </div>
